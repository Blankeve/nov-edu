<template>
  <div class="app-container">
    <h2>{{this.chapter.title != ""?"编辑":"添加"}}章节</h2>
    <div class="myFrm">
      ...
      <br />
      <el-button type="primary" @click="submitForm">添加章节</el-button>
    </div>
  </div>
</template>
<script>
import { getList, getListByTeacherId } from "@/api/course";
import { getAll } from "@/api/teacher";
import { save } from "@/api/chapter";
export default {
  data() {
    return {
      labelPosition: "left",
