package com.maimeng.apigateway.config.exception;
...
//            body = responseStatusException.getMessage();
        } else if(ex instanceof MultiDeviceLoginException){
          httpStatus = HttpStatus.OK;
            try {
                msg = new ObjectMapper().writeValueAsString(BaseResult.setStatus(ResultCode.OTHER_DEVICE_LOGIN));
